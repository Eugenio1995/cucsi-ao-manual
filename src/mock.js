  ...
  },
  {
    ...
    content: {
      ...
      creatures: [
        ...
        { name: 'Beholder', vida: 1250, danoFisico: '25/135', defensa: '-', defMagica: '10', podAtaque: 110, evasion: 60, magia: '-', exp: 3500, oro: 650, drop: '15% - Gema Azul (1 Pto de User)', ubicacion: '104 - 105 - 68 - 125' },
        ...
        { name: 'Galeón Fantasmal', vida: 7000, danoFisico: '350/150', defensa: '12', defMagica: '12', podAtaque: 300, evasion: 100, magia: '-', exp: 17000, oro: 250, drop: '1% - Laúd Mágico, 1% - Flauta Mágica', ubicacion: '134 - 135 - 136' },
        { name: 'Leviatan II', vida: 8000, danoFisico: '250/90', defensa: '-', defMagica: '-', podAtaque: 220, evasion: 95, magia: '-', exp: 26000, oro: 1750, drop: '1% - Casco Incompleto, 1% - Escudo Espada Helada', ubicacion: '134 - 135 - 136' },
    ...
    content: {
      ...
      categories: [
        ...
        },
        {
          ...
          quests: [
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 1/42', nivelMin: 13, nivelMax: 54, necesidad: 'Matar 20 Esqueleto.', criaturas: ['Esqueleto'], recompensa: '1100 de experiencia, 400 monedas de oro y Mascota de Entrenamiento.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 2/42', nivelMin: 14, nivelMax: 54, necesidad: 'Matar 15 Lobo.', criaturas: ['Lobo'], recompensa: '1.500 de experiencia, 600 monedas de oro y Hechizos de Entrenamiento para clases mágicas y equipo de entrenamiento para no mágicas.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 3/42', nivelMin: 15, nivelMax: 54, necesidad: 'Matar 10 Zombie.', criaturas: ['Zombie'], recompensa: '2.200 de experiencia, 800 monedas de oro y 1 Cofre de Entrenamiento I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 4/42', nivelMin: 16, nivelMax: 54, necesidad: 'Matar 15 Tortuga Gigante.', criaturas: ['Tortuga Gigante'], recompensa: '3.000 de experiencia, 1.000 monedas de oro y 1 Cofre de Quest I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 5/42', nivelMin: 17, nivelMax: 54, necesidad: 'Matar 8 Oso Pardo.', criaturas: ['Oso Pardo'], recompensa: '4.300 de experiencia, 1.200 monedas de oro y 1 Cofre de Quest I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 6/42', nivelMin: 18, nivelMax: 54, necesidad: 'Matar 20 Orco.', criaturas: ['Orco'], recompensa: '6.000 de experiencia, 1.500 monedas de oro y 1 Cofre de Quest I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 7/42', nivelMin: 19, nivelMax: 54, necesidad: 'Matar 8 Araña Gigante.', criaturas: ['Araña Gigante'], recompensa: '7.800 de experiencia, 1.800 monedas de oro y 1 Cofre de Entrenamiento II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 8/42', nivelMin: 20, nivelMax: 54, necesidad: 'Matar 8 Asesino.', criaturas: ['Asesino'], recompensa: '10.200 de experiencia, 2.000 monedas de oro y 1 Barca.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 9/42', nivelMin: 21, nivelMax: 54, necesidad: 'Matar 6 Ogro.', criaturas: ['Ogro'], recompensa: '13.200 de experiencia, 2.200 monedas de oro y 1 Cofre de Materiales I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 10/42', nivelMin: 22, nivelMax: 54, necesidad: 'Matar 10 Beholder.', criaturas: ['Beholder'], recompensa: '15.900 de experiencia, 2.500 monedas de oro y 1 Cofre de Materiales I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 11/42', nivelMin: 23, nivelMax: 54, necesidad: 'Matar 10 Orco Brujo.', criaturas: ['Orco Brujo'], recompensa: '19.100 de experiencia, 2.800 monedas de oro y 1 Cofre de Quest I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 12/42', nivelMin: 24, nivelMax: 54, necesidad: 'Matar 10 Liche.', criaturas: ['Liche'], recompensa: '22.900 de experiencia, 3.000 monedas de oro y 1 Cofre Quest II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 13/42', nivelMin: 25, nivelMax: 54, necesidad: 'Matar 10 Lord Orco.', criaturas: ['Lord Orco'], recompensa: '27.500 de experiencia, 3.400 monedas de oro y 1 Relampago para mágicos y Conjuro del estupor para no mágicas.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 14/42', nivelMin: 26, nivelMax: 54, necesidad: 'Matar 10 Mago Malvado.', criaturas: ['Mago Malvado'], recompensa: '35.700 de experiencia, 3.800 monedas de oro y 1 Cofre de Clase I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 15/42', nivelMin: 27, nivelMax: 54, necesidad: 'Matar 5 Liche Infernal.', criaturas: ['Liche Infernal'], recompensa: '46.400 de experiencia, 4.200 monedas de oro y 1 Cofre de Quest II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 16/42', nivelMin: 28, nivelMax: 54, necesidad: 'Matar 5 Demonio.', criaturas: ['Demonio'], recompensa: '60.400 de experiencia, 4.500 monedas de oro y 1 Cofre de Materiales II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 17/42', nivelMin: 29, nivelMax: 54, necesidad: 'Matar 2 Golem de Piedra.', criaturas: ['Golem de Piedra'], recompensa: '84.500 de experiencia, 4.800 monedas de oro y 1 Cofre Winterfell I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 18/42', nivelMin: 30, nivelMax: 54, necesidad: 'Matar 15 Leviatan.', criaturas: ['Leviatan'], recompensa: '118.400 de experiencia, 5.200 monedas de oro y 1 Scroll exp (30 min).' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 19/42', nivelMin: 31, nivelMax: 54, necesidad: 'Matar 20 Dinosaurio.', criaturas: ['Dinosaurio'], recompensa: '125.600 de experiencia, 5.600 monedas de oro y 1 Cofre de Entrenamiento III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 20/42', nivelMin: 32, nivelMax: 54, necesidad: 'Matar 10 Pirata.', criaturas: ['Pirata'], recompensa: '166.300 de experiencia, 6.000 monedas de oro y 1 Cofre materiales II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 21/42', nivelMin: 33, nivelMax: 54, necesidad: 'Matar 10 Capitán Pirata.', criaturas: ['Capitán Pirata'], recompensa: '212.200 de experiencia, 7.000 monedas de oro y 1 Cofre de Quest II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 22/42', nivelMin: 34, nivelMax: 54, necesidad: 'Matar 15 Arquero del Castillo.', criaturas: ['Arquero del Castillo'], recompensa: '275.900 de experiencia, 8.000 monedas de oro y 1 Cofre de Clase I.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 23/42', nivelMin: 35, nivelMax: 54, necesidad: 'Matar 15 Plebello del Castillo.', criaturas: ['Plebello del Castillo'], recompensa: '358.700 de experiencia, 9.000 monedas de oro y 1 Cofre de Quest II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 24/42', nivelMin: 36, nivelMax: 54, necesidad: 'Matar 10 Mago del Castillo.', criaturas: ['Mago del Castillo'], recompensa: '466.600 de experiencia, 10.000 monedas de oro y 1 Cofre de Materiales II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 25/42', nivelMin: 37, nivelMax: 54, necesidad: 'Matar 10 Guerrero Armado del Castillo.', criaturas: ['Guerrero Armado del Castillo'], recompensa: '600.600 de experiencia, 11.000 monedas de oro y 1 Cofre de Quest III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 26/42', nivelMin: 38, nivelMax: 54, necesidad: 'Matar 10 Archimago del Castillo.', criaturas: ['Archimago del Castillo'], recompensa: '788.800 de experiencia, 12.000 monedas de oro y 1 Cofre de Materiales III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 27/42', nivelMin: 39, nivelMax: 54, necesidad: 'Matar 10 Paladin del Castillo.', criaturas: ['Paladin del Castillo'], recompensa: '1.024.000 de experiencia, 13.000 monedas de oro y 1 Scroll exp (30 min).' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 28/42', nivelMin: 40, nivelMax: 54, necesidad: 'Matar 5 Arcangel Armado del Castillo.', criaturas: ['Arcangel Armado del Castillo'], recompensa: '1.229.000 de experiencia, 14.000 monedas de oro y 1 Cofre de Quest II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 29/42', nivelMin: 41, nivelMax: 54, necesidad: 'Matar 2 Rey Golem de Polo.', criaturas: ['Rey Golem de Polo'], recompensa: '1.180.000 de experiencia, 22.500 monedas de oro y 1 Cofre de Materiales II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 30/42', nivelMin: 42, nivelMax: 54, necesidad: 'Matar 2 Golem Junior de Hielo.', criaturas: ['Golem Junior de Hielo'], recompensa: '1.416.000 de experiencia, 22.500 monedas de oro y 1 Cofre Winterfell II.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 31/42', nivelMin: 43, nivelMax: 54, necesidad: 'Matar 10 Sirena.', criaturas: ['Sirena'], recompensa: '1.700.000 de experiencia, 15.000 monedas de oro y 1 Cofre de Runas Inferiores.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 32/42', nivelMin: 44, nivelMax: 54, necesidad: 'Matar 1 Galeón Pirata.', criaturas: ['Galeón Pirata'], recompensa: '2.039.000 de experiencia, 16.000 monedas de oro y 1 Cofre de Runas Inferiores.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 33/42', nivelMin: 45, nivelMax: 54, necesidad: 'Matar 10 Galeón Fantasmal.', criaturas: ['Galeón Fantasmal'], recompensa: '2.447.000 de experiencia, 17.000 monedas de oro y 1 Cofre de Materiales III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 34/42', nivelMin: 46, nivelMax: 54, necesidad: 'Matar 10 Leviatan II.', criaturas: ['Leviatan II'], recompensa: '2.692.000 de experiencia, 18.000 monedas de oro y 1 Scroll exp (30 min).' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 37/42', nivelMin: 47, nivelMax: 54, necesidad: 'Matar 10 Kraken.', criaturas: ['Kraken'], recompensa: '2.961.000 de experiencia, 19.000 monedas de oro y 1 Cofre de Quest III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 38/42', nivelMin: 48, nivelMax: 54, necesidad: 'Matar 5 Golem Dorado.', criaturas: ['Golem Dorado'], recompensa: '3.257.000 de experiencia, 20.000 monedas de oro y 1 Cofre de Materiales III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 39/42', nivelMin: 49, nivelMax: 54, necesidad: 'Matar 3 Golem Alado.', criaturas: ['Golem Alado'], recompensa: '3.583.000 de experiencia, 21.000 monedas de oro y 1 Cofre de Clase III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 40/42', nivelMin: 50, nivelMax: 54, necesidad: 'Matar 25 Medusa.', criaturas: ['Medusa'], recompensa: '3.942.000 de experiencia, 23.000 monedas de oro y 1 Cofre de Dragón.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 41/42', nivelMin: 51, nivelMax: 54, necesidad: 'Matar 10 Gran Dragón Rojo.', criaturas: ['Gran Dragón Rojo'], recompensa: '4.927.000 de experiencia, 25.000 monedas de oro y 1 Cofre de Quest III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 42/42', nivelMin: 52, nivelMax: 54, necesidad: 'Matar 15 Kraken, 15 Medusa', criaturas: ['Kraken', 'Medusa'], recompensa: '6.159.000 de experiencia, 26.000 monedas de oro y 1 Scroll de exp (60 min) + 1 Cofre de Clase III + 1 Cofre de Materiales III.' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 43/43', nivelMin: 53, nivelMax: 54, necesidad: 'Matar 15 Gran Dragon Rojo, 15 Dragon Rojo, 15 Golem Alado y 15 Medusa.', criaturas: ['Gran Dragon Rojo', 'Dragon Rojo', 'Golem Alado', 'Medusa'], recompensa: '7.699.000 de experiencia, 28.500 monedas de oro, 1 Scroll exp (30 min) + 1 Cofre de Clase III + 1 Cofre de Dragón + 1 Cofre de Quest III + 1 Cofre de Copas' },
            { npc: 'Manrique', repetible: false, ubicacion: 'Todas las ciudades', nombre: 'Modo historia - Misión 44/44', nivelMin: 54, nivelMax: 54, necesidad: 'Matar 1 Aparición, 1 Vampiresa, 1 Djinn de Viento, 1 Cíclope, 1 Gran Dragón Plateado, 1 Gran Dragon Negro, 1 Lord Belithuz, 1 Inferno, 1 Elemental de Fuego Errante, 1 Elementar de Agua Errante, 1 Elemental de Tierra Errante, 1 Bestia Guerrera.', criaturas: ['Aparición', 'Vampiresa', 'Djinn de Viento', 'Cíclope', 'Cíclope', 'Gran Dragón Plateado', 'Gran Dragon Negro', 'Lord Belithuz', 'Inferno', 'Elemental de Fuego Errante', 'Elementar de Agua Errante', 'Elemental de Tierra Errante', 'Bestia Guerrera'], recompensa: '0 de experiencia, 190.000 monedas de oro, 1 Gema de Cristal Sagrada' }
          ]
        },
        {
          id: 'repetibles',
          ...
          quests: [
            ...
            { npc: 'Nahia', repetible: true, ubicacion: 'Entrada Inframundo | Mapa:66 X:48 Y:34', nombre: 'Welcome To Pain ZONE', nivelMin: 35, nivelMax: 45, necesidad: 'Matar 15 Serpiente de Anthares, 5 Leviatan, 5 Medusa, 5 Demonio, 2 Golem Dorado y 2 Golem Alado.', criaturas: ['Serpiente de Anthares', 'Leviatan', 'Medusa', 'Demonio', 'Golem Dorado', 'Golem Alado'], recompensa: '217.000 de experiencia, 5.850 monedas de oro, 10 puntos de usuario, 100 Pociones rojas,60 Pociones azules, 20 Pociones amarillas, 10 pociones verdes, 5 jugo de frutas, 5 chuletas y 1 Cofre Quest III.' },
            ...
            { npc: 'Alonso', repetible: true, ubicacion: 'Adentro del Dungeon Veril | Mapa:71 X:38 Y:27', nombre: 'Medukila', nivelMin: 35, nivelMax: 54, necesidad: 'Matar 15 Medusa.', criaturas: ['Medusa'], recompensa: '345.000 de experiencia, 9.000 monedas de oro, 10 puntos de usuario, 100 Pociones rojas,60 Pociones azules, 20 Pociones amarillas, 10 pociones verdes, 5 jugo de frutas, 5 chuletas y 1 Cofre Quest III.' },
    ...
    content: {
      ...
      items: {
        ...
        table: [
          ...
          { item: 'Cofre Bronce', precio: 4, descripcion: 'Obtendrás: 2-Scroll Exp 30m, 2-Scroll Oro 30m y Carrito (Dropea el 70%).' },
          { item: 'Cofre Plata', precio: 6, descripcion: 'Obtendrás: 3-Scroll Exp 30m, 3-Scroll Oro 30m y Carrito (Dropea el 50%).' },
          { item: 'Cofre Oro', precio: 8, descripcion: 'Obtendrás: 4-Scroll Exp 30m, 4-Scroll Oro 30m y Carrito (Dropea el 30%).' },
          { item: 'Cofre Diamante', precio: 12, descripcion: 'Obtendrás: 6-Scroll Exp 30m, 6-Scroll Oro 30m y Carrito (Dropea el 10%).' },
